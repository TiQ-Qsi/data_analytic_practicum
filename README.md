...
|[Исследование интернет-магазина компьютерных игр](game_maekrt)|Выявление факторов успеха компьютерных игр в разрезе регионов и платформ.| `pandas`, `matplotlib`, `numpy`, `Т-тест`, `seaborn`|
