...
|[Исследование интернет-магазина компьютерных игр](game_maekrt)|Выявление факторов успеха компьютерных игр в региональном разрезе и для разных платформ.| `pandas`, `matplotlib`, `numpy`, `Т-тест`, `seaborn`|
